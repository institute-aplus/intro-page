...
export const mastodon: Mastodon | null = getSiteConfig('mastodon', null)
...
//   getSiteConfig('isRedisEnabled', false) || !!getEnv('REDIS_ENABLED', undefined)

// (if you want to enable redis, only REDIS_HOST and REDIS_PASSWORD are required)
// we recommend that you store these in a local `.env` file
// export const redisHost: string | null = getEnv('REDIS_HOST', undefined)
// export const redisPassword: string | null = getEnv('REDIS_PASSWORD', undefined)
